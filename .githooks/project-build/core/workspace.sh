...
project_workspace_observe() (
	project_workspace_repository=$1
	project_workspace_scope=$2
	project_workspace_observed=$3
	project_workspace_targets=$4
	project_workspace_helper=$5
	project_workspace_projects="$project_workspace_repository/Projects"
	project_workspace_workspace="$project_workspace_repository/GitIt.xcworkspace"
	...
	xargs -0 -n 1 "$project_workspace_helper" --select-one \
		"$project_workspace_projects" "$project_workspace_scope" \
...
project_workspace_select_one() {
	...
	project_workspace_scope=$2
	project_workspace_targets=$3
	project_workspace_scheme_file=$4
	...
	project_workspace_decision=$(scheme_policy_decide \
		"$project_workspace_projects" "$project_workspace_scheme_file" \
