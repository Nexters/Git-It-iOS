...
. "$root/.githooks/project-build/core/scheme-policy.sh"
. "$root/.githooks/project-build/core/run-all.sh"
...
assert_equal eligible "$(scheme_policy_decide /repo/Projects /repo/Projects/App/xcshareddata/xcschemes/App.xcscheme all false)" '공유 scheme 선택'
assert_equal ineligible "$(scheme_policy_decide /repo/Projects /repo/Private/App.xcscheme all false)" '경계 밖 scheme 제외'
assert_equal eligible "$(scheme_policy_decide /repo/Projects /repo/Projects/App/xcshareddata/xcschemes/App.xcscheme testable true)" '테스트 scheme 선택'
assert_equal ineligible "$(scheme_policy_decide /repo/Projects /repo/Projects/App/xcshareddata/xcschemes/App.xcscheme testable false)" '비테스트 scheme 제외'
