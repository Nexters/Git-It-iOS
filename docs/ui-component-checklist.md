...
- 분리 기준과 구현 방식은 [UIComponent 컨벤션](./conventions/ui-component.md)
- 구현 컨벤션(공개 생성 경로, 토큰, 중첩 선언, 접근성, 프리뷰)은
  [View 컨벤션](./conventions/view.md)
- 토큰 카테고리는 [DesignSystem README](../sources/Projects/UI/DesignSystem/README.md)
...
바뀌면 이 문서가 아니라 [View 컨벤션](./conventions/view.md) 또는
[UIComponent 컨벤션](./conventions/ui-component.md)을 수정합니다.
