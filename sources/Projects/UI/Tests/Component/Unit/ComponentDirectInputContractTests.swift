...
struct ComponentDirectInputContractTests {
    ...
    func `모든 public component는 ViewModel 없이 직접 입력으로 생성한다`() {
        ...
        _ = ResourceImage(asset: .emptyState)
        ...
        _ = HomeProjectCard(title: "Git It", technologies: "Swift", progress: 0.5)
        _ = OnboardingMockup(page: 1)
        _ = ProjectRow(name: "Git It", supportingText: "Swift", progress: 0.5)
        ...
        _ = SelectionCardList(items: [selectionItem], selectedID: selectionItem.id) { _ in }
