...
/// U02 — GitHub repository URL 검증(UC01)과 학습 프로젝트 생성(UC02)을 진행한다. 서버가
/// generation 진행 상태를 내려주지 않으므로 polling State를 만들지 않고 접수 결과
/// (`ProjectRegistrationReceipt`)만 소유한다.
@Reducer
