...
struct GitHubRepositoryResponseDTOTests {
    ...
    func `최소 응답과 추가 wire 필드에서 서비스 필요 데이터만 보존한다`() throws {
        let response = try decode("""
            { "html_url": "https://github.com/facebook/react", "owner": { "avatar_url": "https://avatars.githubusercontent.com/u/69631" }, "stargazers_count": 240000, "topics": ["javascript", "ui"], "full_name": "facebook/react", "language": "JavaScript" }
            """)
    ...
    @Test(arguments: [
        "{ \"html_url\": \"https://github.com/facebook/react\", \"owner\": {}, \"stargazers_count\": 0 }",
        "{ \"html_url\": \"https://github.com/facebook/react\", \"owner\": { \"avatar_url\": null }, \"stargazers_count\": 0, \"topics\": null }",
        "{ \"html_url\": \"https://github.com/facebook/react\", \"owner\": {}, \"stargazers_count\": 0, \"topics\": [] }",
    ])
