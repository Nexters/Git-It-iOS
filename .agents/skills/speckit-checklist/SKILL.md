...
**Check for extension hooks (before checklist generation)**: [공통 확장 훅 프로토콜](../../../.specify/memory/speckit-common-rules.md#확장-훅extension-hooks-프로토콜)을
따르되 훅 키는 `hooks.before_checklist`, 필수 훅의 "Wait for..." 대상 섹션은 "the Execution Steps"이다.
...
**Check for extension hooks (after checklist generation)**: apply the [공통 확장 훅 프로토콜](../../../.specify/memory/speckit-common-rules.md#확장-훅extension-hooks-프로토콜)
with hook key `hooks.after_checklist`.
