...
assert_equal eligible "$(scheme_policy_decide "$projects" "$workspace" "$projects/UI/xcshareddata/xcschemes/UI.xcscheme" unit true)" 'unit scheme 선택'
assert_equal ineligible "$(scheme_policy_decide "$projects" "$workspace" "$projects/UI/xcshareddata/xcschemes/UIUITests.xcscheme" unit true)" 'unit 범위에서 UI test 제외'
assert_equal eligible "$(scheme_policy_decide "$projects" "$workspace" "$projects/UI/xcshareddata/xcschemes/UIUITests.xcscheme" ui true)" 'UI test scheme 선택'
...
assert_equal ineligible "$(scheme_policy_decide "$projects" "$workspace" "$workspace/xcshareddata/xcschemes/AllTests.xcscheme" unit true)" 'unit 범위에서 AllTests 중복 실행 제외'
